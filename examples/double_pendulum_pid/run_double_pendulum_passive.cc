...
static const char* const kDoublePendulumSdfPath =
    "drake-master/examples/double_pendulum_pid/models/double_pendulum.sdf";
...
int DoMain() {
  ...
  dp->Finalize();
  */
  const std::string full_name= FindResourceOrThrow("drake/examples/double_pendulum_pid/models/double_pendulum.sdf");
...
int main(int argc, char** argv) {
  ...
  return  drake::examples::double_pendulum_pid::DoMain();
}
